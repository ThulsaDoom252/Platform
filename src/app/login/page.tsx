...
export default async function LoginPage() {
  ...
  // Никаких ручных списков: в dev берём актуальных учеников прямо из базы.
  const testStudents =
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-page px-4">
      <div className="my-6 w-full max-w-md rounded-2xl bg-surface p-6 ring-1 ring-line shadow-sm sm:p-7">
        ...
        <LoginForm testStudents={testStudents} />
      </div>
    </main>
  );
}
